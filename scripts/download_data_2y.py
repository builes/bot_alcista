"""Descarga 2 años de datos 4h de los top 80 pares USDT con paginación."""
import sys
...
logger = setup_logger("download_2y", SETTINGS.logs_dir)
DATA_DIR = SETTINGS.data_dir
DATA_DIR.mkdir(parents=True, exist_ok=True)


def download_pair(exchange: BinanceExchange, symbol: str) -> bool:
    ...
    try:
        time.sleep(0.5)
        df = exchange.fetch_ohlcv_range(symbol, timeframe="4h")
